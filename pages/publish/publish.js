...
const initPage = () => {
    ...
    publishAnchor.setAttribute('href', `https://github.com/login/oauth/authorize?client_id=${GITHUB_CLIENT_ID}&scope=public_repo&state=${randomString}&redirect_uri=https://ar-js-org.github.io/studio/pages/publish-confirm/index.html`);
